            ...
            try:
                ...
                if enriched:
                    ...
                    if categorized.get('Safe'):
                        ...
                        for college in categorized['Safe'][:5]:  # Top 5
                            with st.container():
                                st.markdown(f"""
                                <div class="college-card safe-college">
                                    <strong>{college.get('name', 'N/A')}</strong><br>
                    ...
                    if categorized.get('Moderate'):
                        ...
                        for college in categorized['Moderate'][:5]:  # Top 5
                            with st.container():
                                st.markdown(f"""
                    ...
                    if categorized.get('Ambitious'):
                        ...
                        for college in categorized['Ambitious'][:5]:  # Top 5
                            with st.container():
                                st.markdown(f"""
